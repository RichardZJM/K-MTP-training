...
Having examined the MTP's performance in prediction tasks, we consider it's performance in vadiation datasets. We first compare the MTP's perfomance relative to validation data which is very similar to it's training schemes. To this end, we compare the predicted force magnitude of atoms from configurations in active learning runs against the coresponding reference data. 100 of these comparisons can be seen in 
In a perfect fit, such comparison would yield  
